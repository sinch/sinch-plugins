---
name: sinch-help
description: Show overview of all Sinch commands available in this extension
---

# Sinch Gemini Extension — Command Overview

Display a concise overview of all Sinch commands available in this extension. Do NOT generate script files. Output the overview directly.
...
2. **Webhooks**
   - /sinch:api:webhooks:create, list, get, update, delete, triggers
...
**Tip**: Run any command with no arguments for interactive mode. Use gemini extensions settings list sinch-gemini-extension to check configured credentials.
