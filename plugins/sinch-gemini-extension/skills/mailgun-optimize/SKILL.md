...
6. For detailed endpoint parameters, fetch the [API reference docs](https://documentation.mailgun.com/docs/inboxready/api-reference/optimize/inboxready.md) or [OpenAPI spec](https://documentation.mailgun.com/_spec/docs/inboxready/api-reference/optimize/inboxready.yaml?download) rather than guessing (trusted first-party docs at `documentation.mailgun.com`).
