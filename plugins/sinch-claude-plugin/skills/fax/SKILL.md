...
**Auth:** HTTP Basic (`keyId:keySecret`) or OAuth2 bearer token. All examples use Basic auth. See [sinch-authentication](../authentication/SKILL.md) for setup.
...
- [Authentication setup](../authentication/SKILL.md)
